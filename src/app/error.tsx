...
export default function Error({
  ...
  return (
    <div className="flex h-fit flex-col items-center justify-center gap-5 dark:invert p-4">
      <div className="h-fit w-full max-w-md rounded-lg">
        ...
        <div className="p-6 text-center md:p-8">
          ...
          <p className="mb-6 text-neutral-600">
            Our server encountered an unexpected plot twist. Don&apos;t worry,
            even the best stories have editing phases.
          </p>
